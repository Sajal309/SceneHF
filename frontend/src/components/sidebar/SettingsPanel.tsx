...
import { GearIcon, PersonIcon, MixIcon, PlusIcon, TrashIcon, CheckboxIcon, SquareIcon } from '@radix-ui/react-icons';
...
function ParamList({ title, params, onUpdate, onAdd, onDelete }: ParamListProps) {
    ...
    return (
        <div className="space-y-2 mt-4">
            ...
            <div className="flex gap-2 mt-3 pt-2 border-t border-gray-800/50">
                <input
                    type="text"
...
export function SettingsPanel() {
    ...
    return (
        <div className="h-full flex flex-col p-4 bg-gray-900 border-r border-gray-800 w-80 text-gray-300 gap-6 overflow-y-auto custom-scrollbar">

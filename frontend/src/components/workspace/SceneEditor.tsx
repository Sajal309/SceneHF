...
import { PlayIcon, ReloadIcon, UpdateIcon, Cross2Icon } from '@radix-ui/react-icons';
...
export function SceneEditor({ job, selectedStep, onRunPlan, onRerunStep, onClearScene }: SceneEditorProps) {
    ...
    return (
        <div className="flex-1 flex flex-col p-6 bg-gray-950">
            {/* Scene Image */}
